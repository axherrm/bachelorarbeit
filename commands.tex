...
\newcommand{\fieldnote}[9]{
	\neworrenewcommand{\fieldnoteextended}[2]{
		\begin{longtable}{|p{2.5cm}|p{11cm}|}
			...
			Kommentare &  #8 \\ \hline
			Gut gelaufen & #9 \\ \hline
			Schlecht gelaufen &  ##1 \\ \hline
...
% shortcut for jadice flow
\newcommand{\ff}{\hyperref[forschungsfrage:1]{Forschungsfrage}\xspace}

% shortcut for jadice flow
\newcommand{\bpp}{Best Prac\-tices und Pat\-terns\xspace}
...
% enable horizontal centering in p{} cells, see https://tex.stackexchange.com/a/157400
\newcolumntype{M}[1]{>{\centering\arraybackslash}m{#1}}

% command for field notes
\newcommand{\fn}[1]{%
  \hyperref[feldnotiz:#1]{#1}\xspace%
}

% multicolumn two: default 2 column mulitcolumn
\newcommand{\mcTwo}[1]{%
  \multicolumn{2}{c}{#1}\xspace%
}
\newcommand{\mcTwoEnd}[1]{%
  \multicolumn{2}{c|}{#1}\xspace%
}
