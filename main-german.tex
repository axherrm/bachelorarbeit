...
Wegen vielen verschiedenen Vorteilen gegenüber monolithischer Anwendungen ist das Architekturprinzip von Microservices im letzten Jahrzehnt immer verbreiteter geworden.
Faktoren wie die einfachere Skalierbarkeit oder bessere Flexibilität bei der Kombination von Technologien kann es für viele Produkte sinnvoll machen, von einer monolithischen Architektur zu einer Microservices-basierten zu migrieren.
Doch die grundlegende Architektur eines Produkts zu verändern, ist ein sehr zeit- und kostspieliger Prozess, der viele Risiken birgt.
...
\input{chapters/3_forschungsfragen}
\input{chapters/4_ähnliche_forschung}
\input{chapters/5_methodik}
\input{chapters/6_anwendung}
\input{chapters/7_erstellung_prototyp}
\input{chapters/8_leistungsanalyse_prototyp}
\input{chapters/9_auswertung}
