\begin{table}%[!h]
  ...
  \caption[Mögliche Filter des \gls{arh} in Phase 2]{
    ...
    \prioTwo{Unterstrichene Filter} sind Filter mit geringerer Priorität (Priorität 2).
    \prioOne{Unterstrichene und fett markierte Filter} sind Filter mit hoher Priorität (Priorität 1).
  }
