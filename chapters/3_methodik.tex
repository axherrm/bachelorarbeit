...
\paragraph{Teilnehmer:}  Die Auswahl der Teilnehmer eines Interviews ist eine wichtige Entscheidung.
...
In dieser Studie wurden die Teilnehmer gezielt nach ihrer Rolle in der Produktentwicklung von \jf ausgewählt.
...
\paragraph{Protokollierung:} Die Interviews wurden durch eine Audioaufzeichnung festgehalten, da dies von \Citet{seaman2008qualitative} sowie von \Citet{Runeson2009} empfohlen wird.
Die alternativen Optionen wären entweder die Protokollierung durch den Interviewer oder einen separaten Protokollant.
...
Die Lösung durch einen Protokollant ist auch nicht optimal, da ein solcher nicht immer zur Verfügung steht und vor allem auch nicht unbedingt genug Wissen hat, um richtig einzuschätzen, welche Informationen wichtig sind.
...
Da ein gutes Verständnis der Verfahren dafür nötig ist, werden die Fragen verfeinert, falls der Kandidat sich mit einer offenen Frage schwertut.
...
Zum Abschluss werden dem Interviewten noch zwei Fragen zur Gesamtbewertung der Anwendung des Frameworks gestellt. Dabei soll er seine Einzelbewertungen der letzten Schritte zusammenfassen und ein Fazit ziehen.

\paragraph{Vorabmaterial:} 
...
Es wird jedoch nicht erwartet, dass die Teilnehmer alle Inhalte im Voraus vollständig verstehen.
