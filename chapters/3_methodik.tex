...
\paragraph{Protokollierung:} Zwei geläufige Optionen für die Aufnahme eines Interviews sind die Protokollierung während des Interviews, entweder durch den Interviewer oder einen separaten Protokollant.
...
Die Rohdaten liegen in Form von Audioaufnahmen der ungefähren Länge von jeweils drei Mal einer Stunde vor. 
Mit den von \Citet{Mayring2019} vorgestellten Techniken \emph{Zusammenfassen} und \emph{Explikation} werden die Audioaufnahmen getrennt transkribiert (Übersicht in \cref{fig:datenanalyse}).
