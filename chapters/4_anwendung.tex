...
Die Suche nach \bpp wird wie auch die Suche nach Migrationsverfahren durch die \glspl{qa} und Filter konfiguriert.
Das bedeutet, dass alle nötigen Eingaben durch die Durchführung von Phase 1 und 2 bereits vorliegen und die Suche ohne weitere Beschreibung durchgeführt wird.
Ausführliche Erläuterungen zu der Konfiguration und Aggregation der Suchen sind in \cref{sec:phase2-suchconfig} und \cref{sec:phase2-suchaggregation} gegeben.
