...
Bevor ein detaillierterer Vergleich der Methoden im Bezug auf \emph{jadice flow} angeführt wird, werden bereits zwei Methode ausgeschlossen:
Die Methode von \Citet{arh-result-no-filter-4} ermöglicht die automatische Umgestaltung eines Java-Monolithen in Microservices unter Angabe einer Dekomposition.
...
Aus ähnlichem Grund wird auch die Methode von \Citet{arh-result-no-filter-1} ausgeschlossen.
