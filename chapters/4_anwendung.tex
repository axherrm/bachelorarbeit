...
Die im vorherigen Abschnitt definierten Suchen werden nun im \gls{arh} angewendet, um geordnete Listen von Ergebnissen zu erhalten. 
Um die Auswahl der Ergebnisse, die manuell betrachtet werden sollen, auf eine adäquate Größe einzugrenzen, wurden die ersten fünf Ergebnisse jeder Suche ausgewählt.
Außerdem wurden alle dem fünften Ergebnis folgenden Ergebnisse übernommen, die die gleiche Anzahl an Übereinstimmungen aufweisen wie das fünfte.
...
Die Ergebnisse dessen sind in \cref{tab:phase2-filter-results} zu sehen.
...
\]
Die Gewichtung der verschiedenen Suchen wurde so gewählt, dass die realistische Suche das Gewicht 1 hat und die anderen Suchen (mit $0,75$, $0,5$ und $0,25$) weniger stark gewichtet werden.
...
\paragraph{Ausschluss:} \result{4} ermöglicht die automatische Umgestaltung eines Java-Monolithen in Microservices unter Angabe einer Dekomposition.
