...
Dieses Problem könnte gelöst werden durch die Umsetzung der Anleitung in Form eines Werkzeugs, das Entwickler bei der Migration unterstützt.
...
\begin{itemize}
	...
	Zum Zeitpunkt der Durchführung dieser Arbeit konnte im Werkzeug nur die Eingabe der Szenarien mit den zugehörigen \glspl{qa} erfolgen.
	Die restlichen Schritte dieser Phase wurden erst nach Abschluss der Arbeit zum Werkzeug hinzugefügt.
...
Durch die Analyse von \emph{jadice flow 1.0} mithilfe des Werkzeugs und weiterer Forschung im Rahmen dieser Bachelorarbeit sollte ein Refactoring-Prozess für \emph{jadice flow 2.0} angestoßen werden.
...
Dadurch wird erforscht, inwiefern das Framework und das Werkzeug für diesen Spezialfall einer bereits existierenden Microservices-Architektur geeignet sind.
...
Außerdem wird die Entwicklung eines Werkzeugs erwähnt, dass das Framework in Form einer webbasierten Lösung umsetzt und Entwickler bei der Migration unterstützt.
