...
In dieser Thesis werden das \emph{Microservices Migration Framework} (ESE-MMF) und das zugehörige Werkzeug des \emph{Empirical Software Engineering} Instituts (ESE) der Universität Stuttgart mit dem Produkt \emph{jadice flow} evaluiert.
