...
Im Gegensatz zu den Aussagen und Fragen in der Einleitung ist bei den folgenden Fragen der Wortlaut wichtig, da die Fragen teilweise offen gestellt werden.
...
\subsection{Allgemeine Vorgehensweise eines/des \gls{mmf}}
...
\begin{enumerate}
	...
	\end{itemize}
	\item Finden Sie die allgemeine Funktions- und Vorgehensweise des \gls{mmf}/\gls{arh} sinnvoll?
	\item Welche Probleme sehen Sie bei der Funktionsweise des Frameworks?
\end{enumerate}
...
\begin{enumerate}
	...
	\begin{itemize}
		\item Wie nützlich schätzen sie diese Methode bei einer potentiellen Anwendung mit \jf ein?
		\item Falls nicht bereits erwähnt: Wie passend wäre Vorgehensweise der Methode auf einer abstrakten Ebene (Art der Eingabe, Bestimmung der Metriken, Extraktion von Microservices)?
		\item Falls nicht bereits erwähnt: Auf einer weniger abstrakten Ebene: Welche konkreten Probleme könnten Sie sich bei der Anwendung mit \jf vorstellen?
	\end{itemize}
	\item  Jeweils für \bpp
	\begin{itemize}
		\item Wie viele der gezeigten Best Practices/Patterns sind bereits in \jf angewendet/teilweise angewendet?
		\item Wie viele der gezeigten Best Practices/Patterns würden Sie als potentiell sinnvoll für die Implementierung einschätzen?
	\end{itemize}
	...
	\item Hätten Sie nach den Ihnen verfügbaren Informationen die Verwendung des MMF/ARH für die Migration von \emph{jadice server} zu Microservices in der Vergangenheit  als sinnvoll und potentiell gewinnbringend betrachtet?
\end{enumerate}
...
\begin{itemize}
	...
	Das Werkzeug kann Entwickler dabei unterstützen, indem es basierend auf den in Phase 1 eingegebenen \acrlongpl{qa} Methoden empfiehlt.
...
\input{field_notes/F15_P3_01_30_2024_Methodenanwendung}
\input{field_notes/F16_P3_02_07_2024_Methodenanwendung_2}
\input{field_notes/F17_P3_02_08_2024_Methodenanwendung_3}
\input{field_notes/F18_P3_02_09_2024_Besprechung_Methodenanwendung}
