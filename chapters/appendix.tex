...
Dabei wird nach einem klaren, strukturierten Plan vorgegangen:
...
Das Framework hat allgemein das Ziel, die Lücke zwischen Industrie und Forschung zu verringern, indem wissenschaftliche Methoden für die Migration zu \acrlongpl{msa} in einem webbasierten Tool kategorisiert und so für die Industrie zugänglich gemacht werden.
...
\begin{itemize}
	...
	Das Tool kann Entwickler dabei unterstützen, indem es basierend auf den in Phase 1 eingegebenen \acrlongpl{qa}n Methoden empfiehlt.
...
%	Doch Bestandteil der Entwicklungszyklen ist auch, das entstehende System anhand der Qualitätsmerkmale zu bewerten.
